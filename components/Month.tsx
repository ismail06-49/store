...
// Array of best-selling product items for this month
const itemsData = [
    ...
    { id: 5, img: item10, name: "The north coat", price: "$260", oldPrice:'$360', stars: 5, numberOfComments: '65' },
    { id: 6, img: item20, name: "Gucci duffle bag", price: "$960", oldPrice:'$1160', stars: 4, numberOfComments: '65' },
    { id: 7, img: item30, name: "RGB liquid CPU Cooler", price: "$160", oldPrice:'$170', stars: 4, numberOfComments: '65' },
    { id: 8, img: item40, name: "Small BookSelf", price: "$360", oldPrice:'$400', stars: 5, numberOfComments: '65' }
];
...
// Month component: Displays best-selling products for the month in a grid
const Month = () => {
                        ...
                        <div key={item.id} className="min-w-[220px] bg-white rounded-lg shadow-md p-4 grid grid-rows-3">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-medium text-red-500 mb-2">
                                    {item.price}
                                    <span className='text-gray-500 ms-2 line-through'>{item.oldPrice}</span>
                                </div>
