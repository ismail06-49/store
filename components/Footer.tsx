...
const Footer = () => {
    return (
        <footer className="w-full bg-[#000022] text-white">
            ...
            <p className="text-white/35 text-center text-lg font-normal py-4"><span>&copy; </span>Copyright <span className="font-medium underline">Ismail</span> &amp; <span className="font-medium underline">Joy</span> 2025. All right reserved</p>
        </footer>
    )
}
